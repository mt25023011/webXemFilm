            ...
            <div class="clearfix wrap-content">
                ...
                <div class="title-block">
                    ...
                    <div class="title-wrapper-xem full">
                        <h1 class="entry-title"><a href="" title="Tôi Và Chúng Ta Ở Bên Nhau" class="tl">Tôi Và
                                Chúng Ta Ở Bên Nhau tập 1</a></h1>
                    </div>
                </div>
                            ...
                            <div class="halim-server">
                                <ul class="halim-list-eps">
                                    <li class="halim-episode">
                                        <a href="{{ route('watch', ['id' => 37976, 'episode' => 1]) }}">
                                    ...
                                    <li class="halim-episode">
                                        <a href="{{ route('watch', ['id' => 37976, 'episode' => 2]) }}">
                                            <span class="halim-btn halim-btn-2 halim-info-1-2 box-shadow"
                                                ...
                                                data-h1="Tôi Và Chúng Ta Ở Bên Nhau - tập 2">
                                                2
                                            </span>
                                        </a>
                                    </li>
