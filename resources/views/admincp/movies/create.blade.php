        ...
        <div class="col-lg-10">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="bi bi-film"></i> Thêm phim mới</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mt-2 border rounded text-center" style="width: 150px; height: 225px; overflow: hidden;">
                                <img id="imagePreview" src="#" alt="Preview" class="img-fluid rounded" style="display: none; object-fit: cover; width: 100%; height: 100%;">
                            </div>
                        </div>
